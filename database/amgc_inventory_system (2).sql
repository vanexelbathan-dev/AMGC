...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 18, 2026 at 06:53 AM
...
INSERT INTO `deliveries` (`delivery_id`, `trip_id`, `so_id`, `pick_list_id`, `customer_id`, `stop_sequence`, `delivery_date`, `delivery_status`, `signed_by`, `remarks`, `created_at`, `updated_at`, `branch_id`, `driver_id`) VALUES
(1, 10, 23, NULL, 2, NULL, NULL, 'in-transit', NULL, NULL, '2026-02-18 03:42:55', '2026-02-18 05:35:58', 1, 2),
(2, 7, 25, NULL, 2, 1, NULL, 'pending', NULL, NULL, '2026-02-18 05:31:23', '2026-02-18 05:31:23', 1, 1),
(3, 11, 22, NULL, 2, 1, NULL, 'pending', NULL, NULL, '2026-02-18 05:31:23', '2026-02-18 05:31:23', 1, 1),
(4, 12, 21, NULL, 4, 1, NULL, 'pending', NULL, NULL, '2026-02-18 05:31:23', '2026-02-18 05:31:23', 1, 1);
...
(2, 'ITEM002', 'Product B', NULL, 'Category 1', 139, 'piece', 150.00, 30, 'active', '2026-02-10 01:38:25', '2026-02-18 03:42:03', 1),
(3, 'ITEM003', 'Product C', NULL, 'Category 2', 145, 'piece', 200.00, 25, 'active', '2026-02-10 01:38:25', '2026-02-12 06:21:22', 2),
(4, 'ITEM004', 'Product D', NULL, 'Category 2', 151, 'piece', 75.00, 100, 'active', '2026-02-10 01:38:25', '2026-02-18 05:22:10', 2),
(5, 'ITEM005', 'Product E', NULL, 'Category 3', 112, 'piece', 250.00, 20, 'active', '2026-02-10 01:38:25', '2026-02-18 03:57:07', 1);
...
(21, 'SO-20260211-7094558', 4, 1, '2026-02-11 00:00:00', NULL, 75.00, 'ready', 5, '2026-02-11 05:18:14', '2026-02-18 05:22:10'),
(22, 'SO-20260211-7130609', 2, 1, '2026-02-11 00:00:00', NULL, 325.00, 'confirmed', 5, '2026-02-11 05:18:50', '2026-02-18 03:55:27'),
...
(25, 'SO-20260211-9607250', 2, 1, '2026-02-11 00:00:00', NULL, 250.00, 'confirmed', 5, '2026-02-11 06:00:07', '2026-02-18 03:05:31'),
...
(11, 'TT-20260218-00022', 22, 22, 1, 1, '2026-02-18', 'planned', NULL, NULL, NULL, 0, 0, NULL, 2, '2026-02-18 03:55:27', '2026-02-18 03:55:27', NULL),
(12, 'TT-20260218-00021', 21, 23, 1, 1, '2026-02-18', 'planned', NULL, NULL, NULL, 0, 0, NULL, 2, '2026-02-18 05:20:23', '2026-02-18 05:20:23', NULL);
...
INSERT INTO `users` (`user_id`, `email`, `password_hash`, `first_name`, `last_name`, `role`, `department`, `status`, `created_at`, `updated_at`, `branch_id`, `driver_id`) VALUES
(1, 'admin@amgc.com', '$2y$10$l6UbK0Nw645/SuS6i7tMW.FFcoIK5E8dDDh5vpKzRHba1ETkI5kIS', 'Admin', 'User', 'admin', 'Management', 'active', '2026-02-10 01:38:25', '2026-02-11 03:12:51', 1, NULL),
(2, 'branch1@amgc.com', '$2y$10$l6UbK0Nw645/SuS6i7tMW.FFcoIK5E8dDDh5vpKzRHba1ETkI5kIS', 'Branch', 'Manager', 'branch_admin', 'Branch 1', 'active', '2026-02-10 01:38:25', '2026-02-11 03:12:51', 1, NULL),
(3, 'warehouse@amgc.com', '$2y$10$l6UbK0Nw645/SuS6i7tMW.FFcoIK5E8dDDh5vpKzRHba1ETkI5kIS', 'Warehouse', 'Manager', 'warehouse', 'Warehouse', 'active', '2026-02-10 01:38:25', '2026-02-11 03:12:51', 1, NULL),
(4, 'delivery@amgc.com', '$2y$10$l6UbK0Nw645/SuS6i7tMW.FFcoIK5E8dDDh5vpKzRHba1ETkI5kIS', 'Delivery', 'Manager', 'delivery', 'Delivery', 'active', '2026-02-10 01:38:25', '2026-02-11 03:12:51', 1, NULL),
(5, 'sales@amgc.com', '$2y$10$l6UbK0Nw645/SuS6i7tMW.FFcoIK5E8dDDh5vpKzRHba1ETkI5kIS', 'Sales', 'Officer', 'sales', 'Sales', 'active', '2026-02-10 01:38:25', '2026-02-11 03:12:51', 1, NULL),
(6, 'vanbathan576@gmail.com', '$2y$10$l6UbK0Nw645/SuS6i7tMW.FFcoIK5E8dDDh5vpKzRHba1ETkI5kIS', 'Van Exel', 'Bathan', 'branch_admin', 'Branch 2', 'active', '2026-02-10 02:22:15', '2026-02-13 05:18:32', 2, NULL),
(7, 'ross@gmail.com', '$2y$10$l6UbK0Nw645/SuS6i7tMW.FFcoIK5E8dDDh5vpKzRHba1ETkI5kIS', 'Ross Andrei', 'Dolor', 'branch_admin', 'Calaca Branch', 'active', '2026-02-12 07:59:58', '2026-02-12 07:59:58', 2, NULL),
(8, 'juan.santos@amgc.com', '$2y$10$l6UbK0Nw645/SuS6i7tMW.FFcoIK5E8dDDh5vpKzRHba1ETkI5kIS', 'Juan', 'Santos', 'delivery', 'Delivery', 'active', '2026-02-18 03:52:23', '2026-02-18 03:52:23', 1, 1),
(9, 'maria.cruz@amgc.com', '$2y$10$l6UbK0Nw645/SuS6i7tMW.FFcoIK5E8dDDh5vpKzRHba1ETkI5kIS', 'Maria', 'Cruz', 'delivery', 'Delivery', 'active', '2026-02-18 03:52:23', '2026-02-18 03:52:23', 1, 2),
(10, 'pedro.reyes@amgc.com', '$2y$10$l6UbK0Nw645/SuS6i7tMW.FFcoIK5E8dDDh5vpKzRHba1ETkI5kIS', 'Pedro', 'Reyes', 'delivery', 'Delivery', 'active', '2026-02-18 03:52:23', '2026-02-18 03:52:23', 2, 3);
...
ALTER TABLE `deliveries`
  ...
  ADD KEY `fk_deliveries_so_001` (`so_id`),
  ADD KEY `fk_deliveries_customer_001` (`customer_id`),
  ADD KEY `fk_deliveries_branch_001` (`branch_id`),
...
ALTER TABLE `deliveries`
  ...
  ADD CONSTRAINT `deliveries_ibfk_5` FOREIGN KEY (`driver_id`) REFERENCES `drivers` (`driver_id`),
  ADD CONSTRAINT `fk_deliveries_branch_001` FOREIGN KEY (`branch_id`) REFERENCES `branches` (`branch_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_deliveries_customer_001` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`customer_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_deliveries_so_001` FOREIGN KEY (`so_id`) REFERENCES `sales_orders` (`so_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_deliveries_trip_001` FOREIGN KEY (`trip_id`) REFERENCES `trip_tickets` (`trip_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `users`
  ...
  ADD CONSTRAINT `users_ibfk_2` FOREIGN KEY (`driver_id`) REFERENCES `drivers` (`driver_id`);
COMMIT;
