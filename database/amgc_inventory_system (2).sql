...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 12, 2026 at 03:25 AM
...
INSERT INTO `customers` (`customer_id`, `customer_name`, `customer_code`, `contact_person`, `email`, `phone_number`, `address`, `city`, `longitude`, `latitude`, `credit_limit`, `credit_used`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Customer ABC Corp', 'CUST001', 'John Doe', 'john@abccorp.com', '02-1111-1111', '100 Business Ave', 'Manila', 121.036376, 13.88217100, 50000.00, 0.00, 'active', '2026-02-10 01:38:25', '2026-02-11 23:29:41'),
(2, 'Customer XYZ Ltd', 'CUST002', 'Jane Smith', 'jane@xyzltd.com', '02-2222-2222', '200 Trade Street', 'Quezon City', 121.036376, 13.88217100, 75000.00, 0.00, 'active', '2026-02-10 01:38:25', '2026-02-11 23:29:26'),
(3, 'Customer DEF Inc', 'CUST003', 'Bob Johnson', 'bob@definc.com', '02-3333-3333', '300 Commerce Rd', 'Makati', 121.036376, 13.88217100, 100000.00, 0.00, 'active', '2026-02-10 01:38:25', '2026-02-11 23:29:00'),
(4, 'Van Exel Bathan', 'CUST004', 'Van Exel Bathan', 'vanbathan576@gmail.com', '09989798098', 'Calumala, Latag, Alitagtag', 'Sta. Teresita', 121.036423, 13.88223100, 0.00, 0.00, 'active', '2026-02-11 03:52:56', '2026-02-11 23:28:34');
...
INSERT INTO `items` (`item_id`, `item_code`, `item_name`, `description`, `category`, `stock`, `unit_type`, `unit_price`, `reorder_level`, `status`, `created_at`, `updated_at`) VALUES
(1, 'ITEM001', 'Product A', NULL, 'Category 1', 290, 'piece', 100.00, 50, 'active', '2026-02-10 01:38:25', '2026-02-11 03:32:38'),
(2, 'ITEM002', 'Product B', NULL, 'Category 1', 145, 'piece', 150.00, 30, 'active', '2026-02-10 01:38:25', '2026-02-11 05:26:32'),
(3, 'ITEM003', 'Product C', NULL, 'Category 2', 145, 'piece', 200.00, 25, 'active', '2026-02-10 01:38:25', '2026-02-11 05:11:41'),
(4, 'ITEM004', 'Product D', NULL, 'Category 2', 155, 'piece', 75.00, 100, 'active', '2026-02-10 01:38:25', '2026-02-11 05:42:21'),
(5, 'ITEM005', 'Product E', NULL, 'Category 3', 118, 'piece', 250.00, 20, 'active', '2026-02-10 01:38:25', '2026-02-11 06:00:07');
...
INSERT INTO `rmr_requests` (`rmr_id`, `rmr_number`, `so_id`, `customer_id`, `item_id`, `return_quantity`, `return_reason`, `reason_details`, `rmr_status`, `received_date`, `received_by`, `inspector_name`, `inspection_type`, `disposition_type`, `created_at`, `updated_at`) VALUES
(6, 'RMR-20260212-1770861909', 25, 2, 5, 1, 'damaged', 'Return via sales interface', 'pending', NULL, NULL, NULL, NULL, NULL, '2026-02-12 02:05:09', '2026-02-12 02:05:09');
...
(6, 'vanbathan576@gmail.com', '$2y$10$l6UbK0Nw645/SuS6i7tMW.FFcoIK5E8dDDh5vpKzRHba1ETkI5kIS', 'Van Exel', 'Bathan', 'admin', 'IT', 'active', '2026-02-10 02:22:15', '2026-02-11 03:12:51', 1);
