...
$page_subtitle = 'Motorpool Write Check, Expenses, Items & Payment History';
...
<title><?php echo h($page_title); ?> - Motorpool</title>
...
/* Motorpool withdrawal cleanup */
.main-content > .profile-card,
.main-content > .profile-section,
.main-content > .account-card,
.main-content > .user-profile-card,
.main-content > #profileContent,
.main-content .content-profile-card,
.main-content .big-profile-card {
    display: none !important;
}
.sidebar .nav-link,
.sidebar .user-name-sidebar,
.sidebar .user-role-sidebar {
    font-weight: 600;
}
</style>
</head>
            ...
            <li class="nav-item dropdown-more">
                ...
                <div class="more-dropdown" id="bankingMobileMenu">
                    <a class="dropdown-item" href="deposit.php"><i class="bi bi-bank"></i><span>Record
                            Deposit</span></a>
                    <a class="dropdown-item active" href="withdrawal.php"><i class="bi bi-journal-check"></i><span>Write
                            Checks</span></a>
...
<!-- Removed duplicate large profile/logout section; sidebar logout remains. -->
